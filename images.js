...
const imagesData = window.localStorage.getItem('productImgs');

window.onbeforeunload = () => {
    window.localStorage.setItem('productImgs', JSON.stringify(productImgs));
};

let productImgs;

if(imagesData) {
    productImgs = JSON.parse(imagesData);
}
else {
    initImages();
}
